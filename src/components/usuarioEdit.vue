<template>
    ...
    <b-card header="Editar Grupos" style="margin-bottom:10px">
        ...
        <div>
            ...
            >
            <b-form-select class="container-select w-50"  v-model="selectSistema" :options="sistema" @change="selectChange(this)">
                <option v-for="sistema in sistemas" v-bind:key="sistema.id">
                     {{sistema.nome}}
                </option>
            </b-form-select>
            <div>
                Selected: {{ selectSistema }}
            </div>
            </b-form-group>
            <b-form-group
                class="label-select"
                ...
                label-for="filterInput"
            >
            <b-form-select class="container-select w-20" v-model="grupo" :options="grupo">
                <option v-for="grupo in grupos" v-bind:key="grupo.id">
